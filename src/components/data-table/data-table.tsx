...
export interface DataTableProps<TData, TValue> {
  ...
  handleSelect?: (selectedRows: Row<TData>[]) => void;
    ...
    <div className="space-y-4">
      <div className="border-b ">
        <Table className="border">
          <TableHeader className="text-sm font-bold text-gray-800 border-t border-b-4">
          ...
          <TableBody className="text-gray-800 border-b">
